...
resource "azurerm_resource_group" "demoRG" {   # Reference Name for terraform 
            name = "demoRG"     # for portal or human 
...
# terraform apply 
# terrafrom destroy -target="azurerm_linux_virtual_machine.mylinuxvm" 
